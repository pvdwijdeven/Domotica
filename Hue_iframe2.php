...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="css/hue2.css?v=3.0">
	...
	<body>
		...
		function rgbtoxy(red,green,blue){
			var Y=1.0;
			red = (red > 0.04045) ? Math.pow((red + 0.055) / (Y + 0.055), 2.4) : (red / 12.92);
			green = (green > 0.04045) ? Math.pow((green + 0.055) / (Y + 0.055), 2.4) : (green / 12.92);
			blue = (blue > 0.04045) ? Math.pow((blue + 0.055) / (Y + 0.055), 2.4) : (blue / 12.92); 
