...
<form action="putFace2.php" method="post" enctype="multipart/form-data">
    Selecteer afbeelding om te uploaden:
    <input type="file" name="fileToUpload" id="fileToUpload">
    <input type="submit" value="Upload Image" name="submit">
</form>
<form action="detectFace2.php" method="post" enctype="multipart/form-data">
	...
	<script language="JavaScript" type="text/javascript">
		...
		function snapshot(){
			 window.location.href = "frontdoor.php?savefile=2";
		}
